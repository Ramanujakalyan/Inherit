...
FavBrandsController.controller("FavBrandsController", ["$scope", "RemoteDataService", "$ionicLoading", "$window", "FavBrandsService", "ConnectionService", "ToastService", function($scope, RemoteDataService, $ionicLoading, $window, FavBrandsService, ConnectionService, ToastService){
...
FavBrandsController.controller("SelectBrandsController", ["$scope", "brandsData", "catBrandsMallsService", "FavBrandsService", "ToastService", "$state", function($scope, brandsData, catBrandsMallsService,
...
FavBrandsController.controller("BrandLocController", ["$scope", "brandDetailsData", "brandLocData", function($scope, brandDetailsData, brandLocData){
...
FavBrandsController.controller("BrandDealsController", ["$scope", "brandDetailsData", "brandDealsData", "FavBrandsService", function($scope, brandDetailsData, brandDealsData, FavBrandsService){
